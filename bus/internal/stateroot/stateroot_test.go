...
func TestSessionSocketUsesTheDocumentedDiscoveryOrder(t *testing.T) {
	...
	if got, err := SessionSocket(); err != nil || got != filepath.Join(xdg, "agent-sessions", "run", "presence.sock") {
