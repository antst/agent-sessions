...
| Size cap | **1,135 production / 1,165 test logical lines**, including ACP framing, both launcher modes, and leader bootstrap but excluding the shared wrapper host. | The measured implementation is 1,134 / 1,162: the interactive launcher owns the private leader, quiet hold, post-readiness observer, artifact gate, and exact headless classification in addition to the lane's ACP lifecycle. |
