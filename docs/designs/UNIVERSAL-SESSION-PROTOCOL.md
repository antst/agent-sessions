...
| Size cap | **1,075 production / 970 test logical lines**, including ACP framing, both launcher modes, and leader bootstrap but excluding the shared wrapper host. | The measured implementation is 1,073 / 964: the interactive launcher now owns the private leader and exact headless classification in addition to the lane's ACP lifecycle. |
