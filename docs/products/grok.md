...
- verified: Grok Build 1.0.13 — the resident observer authenticates after leader socket readiness and before the TUI starts; that same connection stays resident for readiness, roster changes, and delivery. source: `c5b280d:internal/bridge/grok_native_session.go:83-135`; `c5b280d:internal/bridge/grok_native_observer.go:22-45`; `/home/antst/agentbus-evidence/grok-new-20260906T164113Z`
