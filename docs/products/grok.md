...
- verified: Grok Build 1.0.13 — an interjection while the actor is working is injected into that run; an idle interjection is held by Grok and appears at the next prompt, so no wrapper FIFO is used. source: `/home/antst/agentbus-evidence/grok-20260906T072333Z/P1-P7-acp-raw-v3.txt`
