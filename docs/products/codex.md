...
- After both test threads were archived and their two MCP helpers exited, the interactive product's reusable `codex-code-mode-host` remained under its host-wide App Server daemon; it is product-owned and carries no Agentbus identity. — verified: 0.153.4 — source: `/home/antst/agentbus-evidence/codex-cells-20260906T094434Z/C9-peer-resume-errors/residual-code-mode-host.txt`
