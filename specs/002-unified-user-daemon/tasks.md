...
- [ ] T035 [P] [US2] Add failing attachment prepare/select/adopt/refresh/detach, connector reconnect, exact-evidence, ambiguous-name, bare-session, and active-peer upgrade-generation preservation tests in internal/daemon/attachment_test.go
...
- [ ] T041 [US2] Implement the daemon-owned attachment registry, launch capabilities, session preferences, exact actor evidence, publication, and restart reconciliation in internal/daemon/attachment.go
