...
- [X] T053 [US3] Add a deterministic complete 16-edge composition runner with unique tokens, exact anchor assertions, and one fresh trusted target workspace that contains no local MCP configuration in `scripts/test-qwen-composition`
