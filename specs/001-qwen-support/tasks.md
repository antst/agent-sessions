...
- [X] T071 [US5] Integrate the foundational `install-qwen` target into default-profile `install-all`, upgrade/removal, and release-install flows in `Makefile`; qwen peer/lane binary build targets are owned by T026 and T039
