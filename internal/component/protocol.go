// Package component defines the live component messages shared by products.
package component
...
const (
	ProtocolVersion = 1
	// ContractRevision identifies the installed daemon/client vocabulary.
...
var knownFrameTypes = map[FrameType]struct{}{
	TypeSessionAnnounce: {}, TypeSessionRebind: {}, TypeSessionRename: {}, TypeSessionRenameRequest: {}, TypeSessionState: {}, TypeSessionClose: {},
	TypeSessionBound: {}, TypeDeliveryPresent: {}, TypeDeliveryAccept: {}, TypeDeliveryReject: {},
	TypeTurnEvent: {}, TypeToolCall: {}, TypeToolCancel: {}, TypeToolResult: {}, TypeReject: {},
}
...
func NewFrame(frameType FrameType, id string, _ uint64, payload any) (Frame, error) {
	...
	return Frame{Version: ProtocolVersion, Type: frameType, ID: id, Payload: body}, nil
}
...
var sensitiveAssignment = regexp.MustCompile(`(?i)(password|secret|token)(\s*[:=]\s*)(?:"[^"]*"|'[^']*'|[^\s,;}]+)`)
