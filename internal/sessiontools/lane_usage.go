...
Options include --name, --cd, --model, --effort, --sandbox, --approval-policy,
...
Options include --name, --cd, --model, --effort, --permission-mode,
...
Options include --name, --cd, --model, --reasoning-effort,
